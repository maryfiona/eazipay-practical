...
const Navbar =() =>{
  ...
  <nav
    className="flex-no-wrap relative flex w-full items-center justify-between   py-2 shadow-md shadow-black/5  dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4"
    data-te-navbar-ref>
    <div className="flex w-full flex-wrap items-center justify-between px-3">
      ...
      <div
        ...
        <a
          ...
          href="/">
          <img className="im" src={easipay}alt="eazipay" />
        </a>
        ...
        {/* <ul
          ...
          <li className="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
            ...
            <a
              ...
              focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2
               [&.active]:text-black/90 dark:[&.active]:text-zinc-400"
              href="/"
        ...
        <ul className="list-style-none mr-auto flex flex-col justify-center pl-0 lg:flex-row"
          data-te-navbar-nav-ref>
                    <li className="mb-4 lg:mb-0 lg:pr-6" data-te-nav-item-ref >
                        <a   className="lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400" href="/"
                        data-te-nav-link-ref>Individual</a>
                        </li>
                        <li className="mb-4 lg:mb-0 lg:pr-6">
                        <a href="/" 
                        data-te-nav-link-ref>Business</a>
                        </li>
                        <li className="mb-4 lg:mb-0 lg:pr-6">
                        <a href="/"
                        ...
                        <li className="mb-4 lg:mb-0 lg:pr-6">
                        <a href="/"  
                        data-te-nav-link-ref>Set your payroll</a>
                        </li>
                        </ul>
