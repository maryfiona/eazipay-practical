...
const Individual = () => {
    return (
        ...
        <div className='flex justify-center  p-10'>
            <div className='box content h-72  w-96  bg p-10 Static border-2'>
            ...
            <div className='box content  h-72 w-96 bg p-10 absolute border-2 '>
            ...
            <div className='box content  h-72 w-96 bg p-10 relative border-2'  >
