...
const Individual = () => {
    return (
        ...
        <div className='flex justify-center  p-10'>
            <div className='box content h-80 w-96  bg p-10 Static border-2'>
            ...
            <div className='box content h-76 w-96 bg p-10 absolute border-2 '>
                <h1 className='text-2xl text-white'> All Payroll Anytime Anywhere</h1>
            ...
            <div className='box content h-80 w-96 bg p-10 relative border-2'  >
